...
#include "xdl.h"
// ========================================================================================================================================== //
#define IL2CPP__TAG "UnityRenderer"
...
void *get_export_function(const char *lib, const char *name)
{
    for (int i = 0; i < 10; i++){
        ...
        if (handle) {
            void *fn = xdl_sym(handle, name, nullptr);
            if (fn) {
                return fn;
            }
        }
...
// ========================================================================================================================================== //
#define GAME_LIB_ENGINE YK("libil2cpp.so")
...
uintptr_t Il2CppBase(){
    ...
    FILE *f = fopen(YK("/proc/self/maps"), "r");
...
// ========================================================================================================================================== //
const char* Il2CppStringx::CString() {
    return utf16_to_utf8(&this->start_char, this->length);
}
// ========================================================================================================================================== //
const wchar_t* Il2CppStringx::WCString() {
...
int Il2Cpp::Attach(const char *libname) {
    ...
    not_found_export = 0; // Reset for retry support

    il2cpp_assembly_get_image = (const void *(*)(const void *)) get_export_function(libname, YK("il2cpp_assembly_get_image"));

    il2cpp_domain_get = (void *(*)()) get_export_function(libname, YK("il2cpp_domain_get"));

    il2cpp_domain_get_assemblies = (void **(*)(const void* , size_t*)) get_export_function(libname, YK("il2cpp_domain_get_assemblies"));

    il2cpp_image_get_name = (const char *(*)(void *)) get_export_function(libname, YK("il2cpp_image_get_name"));

    il2cpp_class_from_name = (void* (*)(const void*, const char*, const char *)) get_export_function(libname,YK("il2cpp_class_from_name"));

    il2cpp_class_get_field_from_name = (void* (*)(void*, const char *)) get_export_function(libname, YK("il2cpp_class_get_field_from_name"));

    il2cpp_class_get_method_from_name = (void* (*)(void *, const char*, int)) get_export_function(libname, YK("il2cpp_class_get_method_from_name"));

    il2cpp_field_get_offset = (size_t (*)(void *)) get_export_function(libname, YK("il2cpp_field_get_offset"));

    il2cpp_field_static_get_value = (void (*)(void*, void *)) get_export_function(libname,YK("il2cpp_field_static_get_value"));

    il2cpp_field_static_set_value = (void (*)(void*, void *)) get_export_function(libname, YK("il2cpp_field_static_set_value"));

    il2cpp_array_new = (void *(*)(void*, size_t)) get_export_function(libname, YK("il2cpp_array_new"));

    il2cpp_type_get_name = (char *(*)(void *)) get_export_function(libname, YK("il2cpp_type_get_name"));

    il2cpp_method_get_param = (void *(*)(void *, uint32_t)) get_export_function(libname, YK("il2cpp_method_get_param"));

    il2cpp_class_get_methods = (void *(*)(void *, void **)) get_export_function(libname, YK("il2cpp_class_get_methods"));

    il2cpp_method_get_name = (const char *(*)(void *)) get_export_function(libname, YK("il2cpp_method_get_name"));

    il2cpp_class_get_name = (const char *(*)(void *)) get_export_function(libname, YK("il2cpp_class_get_name"));

    il2cpp_class_get_nested_types = (void *(*)(void *, void **)) get_export_function(libname, YK("il2cpp_class_get_nested_types"));

    il2cpp_object_new = (void *(*)(void *)) get_export_function(libname, YK("il2cpp_object_new"));
...
void Il2Cpp::GetStaticFieldValue(const char *image, const char *namespaze, const char *clazz, const char *name, void *output) {
    ...
    if(!img) {
        IL2CPP_LOGI(YK("Can't find image %s!"), image);
        return;
    }
    void *klass = GetClass(image, namespaze, clazz);
    if(!klass) {
        IL2CPP_LOGI(YK("Can't find class %s for field %s!"), clazz, name);
        return;
    }

    void *field = il2cpp_class_get_field_from_name(klass, name);
    if(!field) {
        IL2CPP_LOGI(YK("Can't find field %s in class %s!"), name, clazz);
        return;
    }
