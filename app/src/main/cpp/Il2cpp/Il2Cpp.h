...
namespace Il2Cpp {
    int Attach(const char *libname = YK("libil2cpp.so"));
...
template<typename T>
using Array = Il2CppArrayx<T>;


typedef Il2CppStringx String;

template<typename T>
using List = Il2CppListx<T>;


template<typename K, typename V>
using Dictionary = Il2CppDictionaryx<K, V>;
